...
const formSchema = z.object({
  displayName: z.string().min(2, { message: 'Display Name must be at least 5 characters' }),
  firstName: z.string().min(2, { message: 'First Name must be at least 3 characters' }),
...
export default function ProfilePage() {
  ...
  const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await authFetcher.post('/upload', formData, {
        // headers: {
            ...
            <div className="flex flex-col items-center sm:flex-row sm:items-start gap-x-18">
              <div className="flex flex-col items-center gap-4">
                <Avatar className="h-24 w-24">
                  {imagePreview ? (
                    ...
                    <AvatarFallback className="text-2xl">{getInitials(watch("displayName"))}</AvatarFallback>
                  )}
                </Avatar>
              ...
              <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="displayName" {...register("displayName")} placeholder="Your display name" />
