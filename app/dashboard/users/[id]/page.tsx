...
export default function UserDetailsPage() {
  ...
  const handleEmailVerificationToggle = async (verified: boolean) => {
    ...
    try {
      ...
      if(response.success){
        ...
        toast.success(`User email ${verified ? "verified" : "unverified"} successfully`)
      }
    } catch (error) {
  ...
  const handleTeacherApprovalToggle = async (approved: boolean) => {
    ...
    try {
      ...
      toast.success(`Teacher information ${approved ? "approved" : "disapproved"} successfully`)
  ...
  if (!user) {
    return (
      <div className="flex h-[50vh] flex-col items-center justify-center gap-4">
        ...
        <Button className="cursor-pointer" onClick={() => router.back()}>Go Back</Button>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-6 flex items-center">
        <Button variant="ghost" onClick={() => router.back()} className="mr-4 cursor-pointer">
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  {user.isEmailVerified ? "User email is verified" : "User email is not verified"}
                </p>
              </div>
              <div className="flex items-center">
                {updatingEmail ? (
                  ...
                  <Switch checked={user.isEmailVerified} onCheckedChange={handleEmailVerificationToggle} />
                )}
              </div>
            </div>
          </CardContent>
        ...
        {user.teacherInfo && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Teaching qualifications and experience</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <div>
                ...
                <p className="truncate">{user.teacherInfo.resume}</p>
              </div>
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">Teaching Experience</p>
                <p>{user.teacherInfo.teachingExperience} years</p>
              </div>

              <div>
                <p className="text-sm font-medium text-muted-foreground">Teaching Specialty</p>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex items-center">
                  {updatingTeacher ? (
                    ...
                    <Switch checked={user.teacherInfo.isApproved} onCheckedChange={handleTeacherApprovalToggle} />
                  )}
                </div>
              </div>
            </CardContent>
        ...
        {user.studentCategories && user.studentCategories.length > 0 && (
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Subject categories the user is interested in</CardDescription>
            </CardHeader>
            <CardContent>
